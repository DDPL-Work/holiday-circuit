  ...
  useEffect(() => {
    if (token && justLoggedIn && user) {
      if (!allowedWorkspaceRoles.has(user.role)) {
        toast.error("This workspace is only for Operations users.");
        dispatch(logout());
            ...
            {authView === "login" ? (
              ...
              >
                ...
                <p className="mb-4 mt-1.5 text-xs sm:text-sm text-gray-500">
                  Enter your Operations credentials to access your dashboard
                </p>
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        return (
                          <>
                            <button
                              ...
                              className={`flex w-full items-center justify-between gap-3 rounded-2xl border px-4 py-2.5 text-sm outline-none transition ${
                                errors.role
                                  ...
                                  <div className="overflow-y-auto overflow-x-hidden">
                                    {roles.map((r) => {
                                      ...
                                      return (
                                        ...
                                        >
                                          <span className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-700">
                                            <OptionIcon size={12} />
                                          </span>
                                          <span className="min-w-0 flex-1 truncate font-medium text-sm text-slate-800">
                                            {r.label}
                                          </span>
                                          {selected ? (
                  ...
                  <div>
                    <div className="mb-2 flex min-h-[22px] items-center justify-between gap-3">
                      <label className="text-sm font-semibold text-slate-900">Email Address <span className="text-red-700">*</span></label>
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="mt-2 w-full flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-[#0f2d5a] to-[#0a0f1d] py-2.5 text-sm font-medium text-white disabled:cursor-not-allowed disabled:bg-slate-500 hover:from-[#153e7a] hover:to-[#020617] hover:shadow-[0_4px_12px_rgba(15,45,90,0.3)] transition-all duration-300"
                  >
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          placeholder="staff@holidaycircuit.com"
                          className={`w-full rounded-2xl border px-4 py-2 sm:py-2.5 pl-10 text-sm sm:text-base focus:outline-none transition-all ${
