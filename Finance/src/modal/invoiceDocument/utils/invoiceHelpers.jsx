...
export const BANK_LOGOS = {
  'HDFC Bank': (
    <svg className="h-3.5 w-3.5 shrink-0 rounded-xs border border-blue-900/10 shadow-[0_1px_1px_rgba(0,0,0,0.05)]" viewBox="0 0 24 24" fill="none">
  ...
  'Axis Bank': (
    <svg className="h-3.5 w-3.5 shrink-0 rounded-xs border border-red-950/10 shadow-[0_1px_1px_rgba(0,0,0,0.05)]" viewBox="0 0 24 24" fill="none">
