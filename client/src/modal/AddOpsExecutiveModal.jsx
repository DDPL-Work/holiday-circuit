...
export default function AddOpsExecutiveModal({ loading, managerName, onClose, onAdd }) {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      setSuccessMeta({
        ...
        message: data?.message || "Ops executive added successfully",
      });
      setStep(4);
    } catch (err) {
      setError(err?.response?.data?.message || "Failed to add ops executive.");
    }
  };
      ...
      <div className="w-full max-w-[460px] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_28px_70px_rgba(15,23,42,0.28)]">
        <div className="flex items-start justify-between bg-[#233047] px-5 py-4 text-white">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-semibold">Add New Ops Executive</p>
            ...
            <>
              <div className="space-y-4 p-5">
                ...
                <div className="relative rounded-xl border-2 border-blue-500 bg-blue-50 px-4 py-3">
                  <p className="text-sm font-semibold text-blue-700">Ops Executive</p>
                  <p className="mt-1 text-xs text-slate-500">Operations execution - handle bookings, fulfillment &amp; quotations under Ops Manager supervision</p>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input type="text" readOnly value="Operations" className="w-full cursor-not-allowed rounded-lg border border-slate-200 bg-slate-50 px-3 py-2.5 text-sm text-slate-400" />
                  </div>
                  <div>
              ...
              <div className="space-y-4 px-6 py-10 text-center">
                ...
                <div className="space-y-1.5">
                  ...
                  <p className="text-sm text-slate-500">
                    <span className="font-medium text-slate-700">{form.fullName || "Executive"}</span> has been created as <span className="font-medium text-blue-600">Ops Executive</span> and linked to your team.
                  </p>
                </div>
