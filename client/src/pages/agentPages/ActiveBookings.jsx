import { Search, Filter, AlertCircle, FileSearch } from "lucide-react";
      ...
      <motion.div variants={itemVariant} className="overflow-hidden rounded-xl bg-white shadow-sm">
        ...
        <table className="w-full text-xs">
          <thead className="border-b border-b-gray-300 bg-gray-50 text-gray-500">
            <tr>
              <th className="px-4 py-2.5 text-left">Booking ID</th>
              <th className="px-4 py-2.5 text-left">Destination</th>
              <th className="px-4 py-2.5 text-left">Travel Dates</th>
              <th className="px-4 py-2.5 text-left">Pax</th>
                ...
                >
                  <td className="px-4 py-3 font-medium">
                    <div className="flex items-center gap-2">
                      <FileSearch className="h-4 w-4 shrink-0" stroke="url(#icon-gradient)" />
                      <div>
                        <p className="text-xs font-semibold text-slate-800 whitespace-nowrap">{booking.bookingReference}</p>
                        <p className="text-[10px] text-slate-400 whitespace-nowrap">{booking.invoiceNumber}</p>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="px-4 py-3">
                    <span className={`inline-flex w-[150px] items-center justify-center whitespace-nowrap rounded-full px-2.5 py-1.5 text-[11px] font-medium leading-none ${booking.displayStatus.className}`}>
                  ...
                  <td className="px-4 py-3 text-right">
                    <motion.button
                      ...
                      className="rounded-lg bg-gradient-to-r from-slate-950 via-slate-900 to-blue-900 hover:from-black hover:to-blue-800 px-4 py-1.5 text-xs font-medium text-white cursor-pointer shadow-sm transition-all duration-200"
                    >
                      Manage
                    </motion.button>
                  </td>
