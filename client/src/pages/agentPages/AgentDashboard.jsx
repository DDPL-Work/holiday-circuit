    ...
    <section className="space-y-8">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <article className="bg-white p-6 rounded-xl shadow-sm flex justify-between items-center">
          <div>
            ...
            <h2 className="text-2xl font-semibold">1,284</h2>
            <p className="text-xs text-green-600 mt-1">+12% from last month</p>
          </div>
          <div className="p-2 rounded-full bg-blue-100">
            <FileQuestionMark className="text-blue-600 w-5 h-5" />
          </div>
        </article>
      ...
      <article className="bg-white p-6 rounded-xl shadow-sm flex justify-between items-center">
          <div>
            ...
            <h2 className="text-2xl font-semibold">₹ 48,200</h2>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <article className="bg-white p-6 rounded-xl shadow-sm">
          ...
          <div className="space-y-3">
            <button className="w-full flex justify-between items-center px-4 py-2 border rounded-xl border-gray-300 text-sm hover:bg-gray-100">
              Create New Query
              <span><ArrowUpRight className="w-5 h-5 stroke-[1.8] text-gray-500"/></span>
            </button>
            ...
            <button className="w-full flex justify-between items-center px-4 py-2 border rounded-xl border-gray-300 text-sm hover:bg-gray-100">
              ...
              <span className=""><ArrowUpRight className="w-5 h-5 stroke-[1.8] text-gray-500"/></span>
            </button>
          </div>

          <div className="mt-6 text-xs text-gray-500">
            <p className="font-medium text-black mb-1">Pro Tip</p>
            <p className="font-normal mb-3 text-[10px]">
