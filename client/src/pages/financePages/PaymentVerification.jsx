          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
            ...
            <div className={`group relative overflow-hidden rounded-xl border px-3 py-2.5 text-center shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md ${
              ...
              <div className={`mb-1.5 flex items-center justify-center gap-1.5 ${isComplete ? "text-slate-500" : "text-amber-600"}`}>
                ...
                <p className="text-[9px] font-bold uppercase tracking-[0.14em]">Remaining</p>
              </div>
              <p className={`text-[1.08rem] font-bold leading-none ${isComplete ? "text-slate-600" : "text-amber-700"}`}>{formatCurrency(remainingAmount)}</p>
            </div>
          </div>
        </div>
                      ...
                      return (
                        <div key={entry.id || `${entry.amount}-${index}`} className="relative">
                          <div className="absolute left-[-25px] top-2 flex h-4 w-4 items-center justify-center rounded-full bg-[#163B72] shadow-sm">
                            <svg className="h-2.5 w-2.5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.8}>
                          ...
                          <div className={`rounded-xl border px-3.5 py-2.5 shadow-sm transition-all duration-300 ${
                            ...
                            <div className="mt-1 flex items-end justify-between gap-3">
                              <p className="text-[0.95rem] font-semibold leading-none text-slate-900">{formatCurrency(entry.amount)}</p>
                    ...
                    className={`absolute left-[-25px] top-2 flex h-4 w-4 items-center justify-center rounded-full shadow-sm ${
                      ...
                      >
                        <div className="flex items-center justify-between gap-3">
                          <p className={`text-[12.5px] font-semibold ${isComplete ? "text-emerald-700" : "text-amber-700"}`}>
                            {isComplete ? "Payment complete" : "Remaining balance"}
                          </p>
                          <p className={`text-[0.95rem] font-semibold leading-none ${isComplete ? "text-emerald-700" : "text-amber-600"}`}>
                      ...
                      <div className="relative">
                        ...
                        <div className="group relative ml-3 overflow-hidden rounded-xl border border-indigo-100 bg-gradient-to-br from-indigo-50/80 via-white to-indigo-50/30 px-3.5 py-2.5 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md">
                          <div className="flex items-start justify-between gap-3">
                            <div>
                              <p className="text-[12.5px] font-semibold text-indigo-700">Send latest payment receipt</p>
                          ...
                          >
                            <Send className={`h-3 w-3 ${sendingAgentReceipt ? "animate-pulse" : ""}`} />
                            {sendingAgentReceipt
                              ? "Sending..."
                              : "Send Latest Receipt"}
                          </button>
