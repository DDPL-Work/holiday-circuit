...
const Login = () => {
  ...
  useEffect(() => {
    if (token && justLoggedIn && user) {
      if (user.role !== "dmc_partner") {
        toast.error("This workspace is only for DMC Partner users.");
        dispatch(logout());
            ...
            {authView === "login" ? (
              ...
              >
                ...
                <p className="mb-4 mt-1.5 text-xs sm:text-sm text-gray-500">
                  Enter your DMC Partner credentials to access your dashboard
                </p>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="partner@holidaycircuit.com"
