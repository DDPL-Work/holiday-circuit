  ...
  if (!term) {
    return (
      <div className="p-8 text-center text-gray-500">
        ...
        <button 
          onClick={() => navigate('/admin/terms-conditions')}
    ...
    <section className="space-y-5 p-6 font-sans">
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 font-medium min-w-0">
          ...
          <button onClick={() => navigate('/admin/terms-conditions')} className="hover:text-gray-900 transition-colors cursor-pointer shrink-0">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            onClick={() => navigate(`/admin/terms-conditions/${id}/edit`)}
